...
class SbiCcStatementProcessor(BankStatementInterface):
    ...
    def __init__(self, filepath, source):
        ...
        self.parser = SbiCustomPdfParser(filepath, config[config_name]['record_selector_regex'],
                                         config[config_name]['igst_selector_regex'],
                                         config[config_name]['igst_date_regex'], data_header_list)
